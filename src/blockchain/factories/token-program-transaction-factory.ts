import { Connection, PublicKey, PublicKeyInitData, TransactionInstruction, TransactionMessage } from "@solana/web3.js";
...
export class TokenProgramTransactionFactory {
    ...
    async generateTransferTransaction(
        ...
        txInstructions.push(
            await TokenProgramInstructionFactory.Instance.createTransferInstructions(from, to, mintAddress, amount),
        );
